<?php 
/*
 Plugin Name: VW Furniture Carpenter Pro Posttype
 lugin URI: https://www.vwthemes.com/
 Description: Creating new post type for VW Furniture Carpenter Pro Theme.
 Author: VW Themes
 Version: 1.0
 Author URI: https://www.vwthemes.com/
*/

define( 'VW_FURNITURE_CARPENTER_PRO_POSTTYPE_VERSION', '1.0' );
add_action( 'init', 'vw_furniture_carpenter_pro_posttype_create_post_type' );
add_action( 'init', 'projectscategory');

function vw_furniture_carpenter_pro_posttype_create_post_type() {

  register_post_type( 'services',
    array(
        'labels' => array(
            'name' => __( 'Services','vw-furniture-carpenter-pro-posttype' ),
            'singular_name' => __( 'Services','vw-furniture-carpenter-pro-posttype' )
        ),
  ...
  register_post_type( 'projects',
    array(
        'labels' => array(
            'name' => __( 'Projects','vw-furniture-carpenter-pro-posttype' ),
            'singular_name' => __( 'Projects','vw-furniture-carpenter-pro-posttype' )
        ),
        'capability_type' =>  'post',
  ...
  register_post_type( 'testimonials',
    array(
      'labels' => array(
        'name' => __( 'Testimonial','vw-furniture-carpenter-pro-posttype' ),
        'singular_name' => __( 'Testimonial','vw-furniture-carpenter-pro-posttype' )
      ),
      'capability_type' => 'post',
  ...
  register_post_type( 'team',
    array(
      'labels' => array(
        'name' => __( 'Team','vw-furniture-carpenter-pro-posttype' ),
        'singular_name' => __( 'Team','vw-furniture-carpenter-pro-posttype' )
      ),
        'capability_type' => 'post',
        'menu_icon'  => 'dashicons-businessman',
        'public' => true,
...
function vw_furniture_carpenter_pro_posttype_images_metabox_enqueue($hook) {
  if ( 'post.php' === $hook || 'post-new.php' === $hook ) {
    wp_enqueue_script('vw-furniture-carpenter-pro-posttype-images-metabox', plugin_dir_url( __FILE__ ) . '/js/img-metabox.js', array('jquery', 'jquery-ui-sortable'));
...
add_action('admin_enqueue_scripts', 'vw_furniture_carpenter_pro_posttype_images_metabox_enqueue');
// Services Meta
function vw_furniture_carpenter_pro_posttype_bn_custom_meta_services() {

    add_meta_box( 'bn_meta', __( 'Services Meta', 'vw-furniture-carpenter-pro-posttype' ), 'vw_furniture_carpenter_pro_posttype_bn_meta_callback_services', 'services', 'normal', 'high' );
}
/* Hook things in for admin*/
if (is_admin()){
  add_action('admin_menu', 'vw_furniture_carpenter_pro_posttype_bn_custom_meta_services');
}

function vw_furniture_carpenter_pro_posttype_bn_meta_callback_services( $post ) {
...
function vw_furniture_carpenter_pro_posttype_bn_meta_save_services( $post_id ) {
...
add_action( 'save_post', 'vw_furniture_carpenter_pro_posttype_bn_meta_save_services' );

/* Services shortcode */
function vw_furniture_carpenter_pro_posttype_services_func( $atts ) {
  ...
  while ($new->have_posts()) : $new->the_post();
        ...
        $services .= '<div class="col-lg-4 col-md-6 col-sm-6" id="services-box">
                        <div class="services_content">
                          <div class="services-icon"><img src="'.esc_url($services_icon).'" class="pra-img">
                          </div>
                          <h4><a href="'.esc_url($custom_url).'">'.esc_html(get_the_title()) .'</a></h4>
                          <div class="services-info">
                            '.$excerpt.'
                          </div>
                          <a href="'.esc_url($custom_url).'"><img class="services-img" src="'.esc_url($thumb_url).'" /></a>
                        </div>
                      </div>';
  ...
  endwhile;
    ...
    $services = '<h2 class="center">'.esc_html__('Post Not Found','vw-furniture-carpenter-pro-posttype').'</h2>';
  endif;
  $services .= '</div>';
  return $services;
}

add_shortcode( 'vw-furniture-carpenter-pro-services', 'vw_furniture_carpenter_pro_posttype_services_func' );
...
function projectscategory() {
  ...
  $labels = array(
    'name'              => __( 'Categories', 'vw-furniture-carpenter-pro-posttype' ),
    'singular_name'     => __( 'Categories', 'vw-furniture-carpenter-pro-posttype' ),
    'search_items'      => __( 'Search cats', 'vw-furniture-carpenter-pro-posttype' ),
    'all_items'         => __( 'All Categories', 'vw-furniture-carpenter-pro-posttype' ),
    'parent_item'       => __( 'Parent Categories', 'vw-furniture-carpenter-pro-posttype' ),
    'parent_item_colon' => __( 'Parent Categories:', 'vw-furniture-carpenter-pro-posttype' ),
    'edit_item'         => __( 'Edit Categories', 'vw-furniture-carpenter-pro-posttype' ),
    'update_item'       => __( 'Update Categories', 'vw-furniture-carpenter-pro-posttype' ),
    'add_new_item'      => __( 'Add New Categories', 'vw-furniture-carpenter-pro-posttype' ),
    'new_item_name'     => __( 'New Categories Name', 'vw-furniture-carpenter-pro-posttype' ),
    'menu_name'         => __( 'Categories', 'vw-furniture-carpenter-pro-posttype' ),
  );
  $args = array(
    'hierarchical'      => true,
    'labels'            => $labels,
...
// events Meta
function vw_furniture_carpenter_pro_posttype_bn_custom_meta_events() {

    add_meta_box( 'bn_meta', __( 'Project Meta', 'vw-furniture-carpenter-pro-posttype-pro' ), 'vw_furniture_carpenter_pro_posttype_bn_meta_callback_events', 'projects', 'normal', 'high' );
}
/* Hook things in for admin*/
if (is_admin()){
  add_action('admin_menu', 'vw_furniture_carpenter_pro_posttype_bn_custom_meta_events');
}

function vw_furniture_carpenter_pro_posttype_bn_meta_callback_events( $post ) {
    wp_nonce_field( basename( __FILE__ ), 'bn_nonce' );
    $bn_stored_meta = get_post_meta( $post->ID );
  ...
  <div id="property_stuff">
    <table id="list-table">     
      <tbody id="the-list" data-wp-lists="list:meta">
        <tr id="meta-2">
          <td class="left">
            <?php _e( 'Project Category', 'vw-furniture-carpenter-pro-posttype' )?>
          </td>
          <td class="left" >
        ...
        <tr id="meta-3">
          <td class="left">
            <?php _e( 'Project Location', 'vw-furniture-carpenter-pro-posttype' )?>
          </td>
          <td class="left" >
        ...
        <tr id="meta-3">
          <td class="left">
            <?php _e( 'Client Or Company Name', 'vw-furniture-carpenter-pro-posttype' )?>
          </td>
          <td class="left" >
...
function vw_furniture_carpenter_pro_posttype_bn_meta_save_events( $post_id ) {
...
add_action( 'save_post', 'vw_furniture_carpenter_pro_posttype_bn_meta_save_events' );

/* projects shortcode */
function vw_furniture_carpenter_pro_posttype_projects_func( $atts ) {
  $projects = '';
        ...
        $projects .= '
            <div class="col-lg-4 col-md-6 col-sm-6 our_projects_outer">
              <div class="box hover_border">
                <img class="projects-img" src="'.esc_url($thumb_url).'" />
  ...
  endwhile;
    ...
    $projects = '<h2 class="center">'.esc_html__('Post Not Found','vw_furniture_carpenter_pro_posttype').'</h2>';
  endif;
  return $projects;
}

add_shortcode( 'vw-furniture-carpenter-pro-projects', 'vw_furniture_carpenter_pro_posttype_projects_func' );



/*---------------------------------- Testimonial section -------------------------------------*/
/* Adds a meta box to the Testimonial editing screen */
function vw_furniture_carpenter_pro_posttype_bn_testimonial_meta_box() {
  add_meta_box( 'vw-furniture-carpenter-pro-posttype-testimonial-meta', __( 'Enter Details', 'vw-furniture-carpenter-pro-posttype' ), 'vw_furniture_carpenter_pro_posttype_bn_testimonial_meta_callback', 'testimonials', 'normal', 'high' );
}
// Hook things in for admin
if (is_admin()){
    add_action('admin_menu', 'vw_furniture_carpenter_pro_posttype_bn_testimonial_meta_box');
}

/* Adds a meta box for custom post */
function vw_furniture_carpenter_pro_posttype_bn_testimonial_meta_callback( $post ) {
  wp_nonce_field( basename( __FILE__ ), 'vw_furniture_carpenter_pro_posttype_posttype_testimonial_meta_nonce' );
  $bn_stored_meta = get_post_meta( $post->ID );
  $desigstory = get_post_meta( $post->ID, 'vw_furniture_carpenter_pro_posttype_testimonial_desigstory', true );
  ...
  <div id="testimonials_custom_stuff">
    <table id="list">
      <tbody id="the-list" data-wp-lists="list:meta">
        <tr id="meta-1">
          <td class="left">
            <?php _e( 'Designation', 'vw-furniture-carpenter-pro-posttype' )?>
          </td>
          <td class="left" >
            <input type="text" name="vw_furniture_carpenter_pro_posttype_testimonial_desigstory" id="vw_furniture_carpenter_pro_posttype_testimonial_desigstory" value="<?php echo esc_attr( $desigstory ); ?>" />
          </td>
        </tr>
        <tr id="meta-2">
          <td class="left">
            <?php _e( 'Facebook Url', 'vw-furniture-carpenter-pro-posttype' )?>
          </td>
          <td class="left" >
        ...
        <tr id="meta-3">
          <td class="left">
            <?php _e( 'Linkedin Url', 'vw-furniture-carpenter-pro-posttype' )?>
          </td>
          <td class="left" >
        ...
        <tr id="meta-4">
          <td class="left">
            <?php _e( 'Twitter Url', 'vw-furniture-carpenter-pro-posttype' ); ?>
          </td>
          <td class="left" >
        ...
        <tr id="meta-5">
          <td class="left">
            <?php _e( 'GooglePlus Url', 'vw-furniture-carpenter-pro-posttype' ); ?>
          </td>
          <td class="left" >
        ...
        <tr id="meta-6">
          <td class="left">
            <?php _e( 'Instagram Url', 'vw-furniture-carpenter-pro-posttype' ); ?>
          </td>
          <td class="left" >
        ...
        <tr id="meta-7">
          <td class="left">
            <?php _e( 'Pinterest Url', 'vw-furniture-carpenter-pro-posttype' ); ?>
          </td>
          <td class="left" >
...
function vw_furniture_carpenter_pro_posttype_bn_metadesig_save( $post_id ) {
  if (!isset($_POST['vw_furniture_carpenter_pro_posttype_posttype_testimonial_meta_nonce']) || !wp_verify_nonce($_POST['vw_furniture_carpenter_pro_posttype_posttype_testimonial_meta_nonce'], basename(__FILE__))) {
    return;
  }
  ...
  // Save desig.
  if( isset( $_POST[ 'vw_furniture_carpenter_pro_posttype_testimonial_desigstory' ] ) ) {
    update_post_meta( $post_id, 'vw_furniture_carpenter_pro_posttype_testimonial_desigstory', sanitize_text_field($_POST[ 'vw_furniture_carpenter_pro_posttype_testimonial_desigstory']) );
  }
  // Save facebookurl
...
add_action( 'save_post', 'vw_furniture_carpenter_pro_posttype_bn_metadesig_save' );

/*---------------------------------- testimonials shortcode --------------------------------------*/
function vw_furniture_carpenter_pro_posttype_testimonial_func( $atts ) {
  $testimonial = '';
  ...
  while ($new->have_posts()) : $new->the_post();
        ...
        $excerpt = wp_trim_words(get_the_excerpt(),15);
        $tdegignation= get_post_meta($post_id,'vw_furniture_carpenter_pro_posttype_testimonial_desigstory',true);
  ...
  endwhile;
    ...
    $testimonial = '<h2 class="center">'.esc_html__('Post Not Found','vw_furniture_carpenter_pro_posttype').'</h2>';
  endif;
  return $testimonial;
}

add_shortcode( 'vw-furniture-carpenter-pro-testimonials', 'vw_furniture_carpenter_pro_posttype_testimonial_func' );

/*-------------------------------------- Team -------------------------------------------*/
/* Adds a meta box for Designation */
function vw_furniture_carpenter_pro_posttype_bn_team_meta() {
    add_meta_box( 'vw_furniture_carpenter_pro_posttype_bn_meta', __( 'Enter Details','vw-furniture-carpenter-pro-posttype' ), 'vw_furniture_carpenter_pro_posttype_ex_bn_meta_callback', 'team', 'normal', 'high' );
}
// Hook things in for admin
if (is_admin()){
    add_action('admin_menu', 'vw_furniture_carpenter_pro_posttype_bn_team_meta');
}
/* Adds a meta box for custom post */
function vw_furniture_carpenter_pro_posttype_ex_bn_meta_callback( $post ) {
    wp_nonce_field( basename( __FILE__ ), 'vw_furniture_carpenter_pro_posttype_bn_nonce' );
    $bn_stored_meta = get_post_meta( $post->ID );
    ...
    <div id="agent_custom_stuff">
        <table id="list-table">         
            <tbody id="the-list" data-wp-lists="list:meta">
                <tr id="meta-1">
                  <td class="left">
                      <?php _e( 'Email', 'vw-furniture-carpenter-pro-posttype' )?>
                  </td>
                  <td class="left" >
                ...
                <tr id="meta-1">
                  <td class="left">
                      <?php _e( 'Phone', 'vw-furniture-carpenter-pro-posttype' )?>
                  </td>
                  <td class="left" >
...
function vw_furniture_carpenter_pro_posttype_ex_bn_metadesig_save( $post_id ) {
...
add_action( 'save_post', 'vw_furniture_carpenter_pro_posttype_ex_bn_metadesig_save' );

add_action( 'save_post', 'bn_meta_save' );
/* Saves the custom meta input */
function bn_meta_save( $post_id ) {
  if( isset( $_POST[ 'vw_furniture_carpenter_pro_posttype_team_featured' ] )) {
      update_post_meta( $post_id, 'vw_furniture_carpenter_pro_posttype_team_featured', esc_attr(1));
  }else{
    update_post_meta( $post_id, 'vw_furniture_carpenter_pro_posttype_team_featured', esc_attr(0));
  }
}
/*------------------------------------- SHORTCODES -------------------------------------*/

/*------------------------------------- team Shorthcode -------------------------------------*/
function vw_furniture_carpenter_pro_posttype_team_func( $atts ) {
  $team = '';
  ...
  while ($new->have_posts()) : $new->the_post();
        ...
        $custom_url = get_permalink();
        $team .= '
            <div class="our_team_outer col-lg-3 col-md-6 col-sm-6">
              <div class="box our-team-content-box">
                <img class="team-img" src="'.esc_url($thumb_url).'" />
                <div class="box-content">
                  <a href="'.esc_url($custom_url).'" class="know-more hvr-icon-wobble-horizontal"><i class="fas fa-angle-right hvr-icon"></i></a>
                  <p>
              ...
              <h4><a href="'.esc_url($custom_url).'">'.esc_html(get_the_title()) .'</a></h4>
              <p class="team-desig">'.$team_desig.'</p>
            </div>';
    if($k%2 == 0){
  ...
  endwhile;
    ...
    $team = '<h2 class="center">'.esc_html__('Post Not Found','vw_furniture_carpenter_pro_posttype').'</h2>';
  endif;
  return $team;
}

add_shortcode( 'vw-furniture-carpenter-pro-team', 'vw_furniture_carpenter_pro_posttype_team_func' );
